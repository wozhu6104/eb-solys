 ...
 ******************************************************************************/
package com.elektrobit.ebrace.viewer.common.provider.messagesView;
...
public class MessagesViewTimestampColumnLabelProvider extends ColumnLabelProvider
        implements
            RowFormatter,
            PreferencesNotifyCallback
{
    ...
    public MessagesViewTimestampColumnLabelProvider(Viewer viewer)
    {
        this.viewer = viewer;
