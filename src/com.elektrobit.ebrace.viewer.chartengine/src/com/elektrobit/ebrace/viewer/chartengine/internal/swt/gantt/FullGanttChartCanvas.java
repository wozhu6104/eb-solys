...
public class FullGanttChartCanvas<T> extends BaseFullChartCanvas<T>
{
    public FullGanttChartCanvas(Set<RuntimeEventChannel<T>> channels, long startTimestampOfFullChartInMillis,
    ...
    {
        return new GanttChartBuilder<T>( modelToDisplay, RunMode.FULL ).addChartTitle( chartTitle );
    }
