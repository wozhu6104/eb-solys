...
public class DeleteChannelFromChartHandler extends AbstractHandler
{
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException
    {
        ...
        removeChannels( model, selectedChannelsList );
        return null;
    }

    private void removeChannels(ResourceModel model, List<RuntimeEventChannel<?>> channelListToBeDeleted)
    {
        List<RuntimeEventChannel<?>> channelsOfModel = model.getChannels();
        channelsOfModel.removeAll( channelListToBeDeleted );
