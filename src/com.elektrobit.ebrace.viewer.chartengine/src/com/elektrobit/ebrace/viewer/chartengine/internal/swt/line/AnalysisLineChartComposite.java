...
public class AnalysisLineChartComposite<T> extends BaseAnalysisChartComposite<T>
{

    public AnalysisLineChartComposite(Composite parent, int style, ChartModel model)
    {
    ...
    {
        fullChartCanvas = new FullLineChartCanvas<T>( fullChartChannels,
    ...
    {
        analysisChartCanvas = new AnalysisLineChartCanvas<T>( analysisChartChannels,
