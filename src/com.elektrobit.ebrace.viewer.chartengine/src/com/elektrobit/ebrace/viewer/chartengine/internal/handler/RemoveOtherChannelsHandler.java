...
public class RemoveOtherChannelsHandler extends AbstractHandler
{
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException
    {
        ...
        if (activePart instanceof ChartEditor)
        {
            ...
            List<RuntimeEventChannel<?>> selectedChannelsList = ChartHandlerUtil.createSelectedChannelsList( list );
            model.setChannels( selectedChannelsList );
        }
