...
public class AnalysisLineChartCanvas<T> extends BaseAnalysisChartCanvas<T>
{

    public AnalysisLineChartCanvas(Set<RuntimeEventChannel<T>> channels, Composite parent, int style, ChartModel model)
    {
    ...
    {
        return new ChartBuilder<T>( modelToDisplay, RunMode.ANALYSIS ).addChartTitle( chartTitle );
    }
