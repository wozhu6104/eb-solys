...
public class CreateEventMapFromChartHandler extends CreateResourcesModelBaseHandler
{
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException
    {
        ...
        {
            createResourceUseCase.createOrGetAndOpenSnapshot( ((ChartModel)o).getChannels() );
        }
        return null;
    }
