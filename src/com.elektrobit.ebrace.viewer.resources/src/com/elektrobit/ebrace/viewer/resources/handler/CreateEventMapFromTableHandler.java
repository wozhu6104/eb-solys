...
public class CreateEventMapFromTableHandler extends CreateResourcesModelBaseHandler
{
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException
    {
        ...
        {
            createResourceUseCase.createOrGetAndOpenSnapshot( ((TableModel)o).getChannels() );
        }
        return null;
    }
}
