...
public class TimeGraphScale extends TimeGraphBaseControl implements
    ...
    private boolean fDrawTimeDecorators = true;
    ...
    /**
     * Control if time decorators on the (T1, T2) will be displayed
     *
     * @param draw
     *      if true, T1 and T2 marks will be drawn on the scale, by default true
     */
    public void setDrawTimeDecorators(boolean draw)
    {
        fDrawTimeDecorators  = draw;
    }
}
