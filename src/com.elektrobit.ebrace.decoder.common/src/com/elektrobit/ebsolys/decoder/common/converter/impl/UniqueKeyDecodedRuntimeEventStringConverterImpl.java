...
public class UniqueKeyDecodedRuntimeEventStringConverterImpl implements DecodedRuntimeEventStringConverter
{
    private final DecodedTreeJsonConverter jsonConverter = new DecodedTreeJsonConverter( new EbraceJsonKeyTransformer() );
