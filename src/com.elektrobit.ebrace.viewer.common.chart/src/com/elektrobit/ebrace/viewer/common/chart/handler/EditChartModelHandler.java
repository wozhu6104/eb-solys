...
import com.elektrobit.ebrace.viewer.common.chart.dialog.ChartDialog;
...
public class EditChartModelHandler extends EditResourcesModelHandler
{
    @Override
    protected EditResourceModelNameDialog createDialog(Shell activeShell, ResourceModel selectedModel)
    {
        return new ChartDialog( activeShell, (ChartModel)selectedModel );
    }
}
