...
public class RegExToChannelEventHandlerTest
{
    ...
    // @formatter:on
    // @formatter:off
    public static final String NEW_EVENT_JSON = "{\"uptime\":\"12345\",\"channel\":\"cpu.yourname\",\"value\":\"12\"}";
    // @formatter:on
    ...
    @Test
    public void handleJsonEvent()
    {
        String result = new JsonEventByRegExMapper( REG_EX, "cpu" ).map( event ).toString();
        assertEquals( NEW_EVENT_JSON, result );
    }
}
