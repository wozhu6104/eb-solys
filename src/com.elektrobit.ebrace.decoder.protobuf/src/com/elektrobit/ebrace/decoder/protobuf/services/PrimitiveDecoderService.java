...
@Component(property = {ServiceConstants.CLAZZ_TYPE + "=java.lang.Long", ServiceConstants.CLAZZ_TYPE + "=java.lang.Byte",
        ServiceConstants.CLAZZ_TYPE + "=java.lang.Float", ServiceConstants.CLAZZ_TYPE + "=java.lang.Integer",
        ServiceConstants.CLAZZ_TYPE + "=java.lang.Short", ServiceConstants.CLAZZ_TYPE + "=java.lang.Double",
        ServiceConstants.CLAZZ_TYPE + "=java.lang.Boolean"})
public class PrimitiveDecoderService implements DecoderService, PreferencesListener
{
    ...
    {
        final DefaultPrimitiveDecodedRuntimeEvent defaultPrimitiveDecodedRuntimeEvent = new DefaultPrimitiveDecodedRuntimeEvent( event,
                                                                                                                                 timestampFormat );
        return defaultPrimitiveDecodedRuntimeEvent;
    }
