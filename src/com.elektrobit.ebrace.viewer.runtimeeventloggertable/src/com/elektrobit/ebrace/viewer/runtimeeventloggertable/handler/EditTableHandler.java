...
import com.elektrobit.ebrace.viewer.runtimeeventloggertable.dialog.TableDialog;

public class EditTableHandler extends EditResourcesModelHandler
{
    @Override
    protected EditResourceModelNameDialog createDialog(Shell activeShell, ResourceModel selectedModel)
    {
        return new TableDialog( activeShell, selectedModel );
    }
}
