...
public class NetworkPacketSnifferAdapterFactory extends BaseTargetAdapterFactory<NetworkPacketSnifferAdapter>
{
    ...
    @Override
    protected NetworkPacketSnifferAdapter createNewAdapterInstance(DataSourceContext dataSourceContext)
    {
        return new NetworkPacketSnifferAdapter( runtimeEventAcceptor,
                                                structureAcceptor,
                                                comRelationAcceptor,
                                                dataSourceContext );
    }
    ...
    @Override
    protected void registerInstanceForRequiredServices(NetworkPacketSnifferAdapter adaptor,
