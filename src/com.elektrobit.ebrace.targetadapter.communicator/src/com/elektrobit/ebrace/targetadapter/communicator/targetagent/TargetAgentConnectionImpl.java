...
@Log4j
public class TargetAgentConnectionImpl
        implements
            TargetConnection,
            ...
            ProtoMsgCacheDataAvailableListener
{
            ...
            UserMessageLogger userMessageLogger)
    {
        ...
        String cacheFileName = "stream-cache" + connectionModel.getHost() + "-" + connectionModel.getPort() + "."
                + connectionModel.getConnectionType().getExtension() + ".tmp";
    ...
    {
        return new DataSourceContext( SOURCE_TYPE.CONNECTION, connectionModel.getName() + "." );
    }
    ...
    private void startDataReceiving()
    {
        if (!shallRead)
        {
            ...
            readThread.setName( "Cache: file reader:" + connectionModel.getName() );
            readThread.start();
        }
    }
